...
<div class="jus">
    ...
    <form action="#" method="post">
        <p><i>Separate registrations are required for Delegates and VIP Delegates - ie you can only register one type per form</em></p>
        <div class="js">
            <h4>DELEGATES AND VIPS</h4>

        </div><br>
        <div class="py">
            <h5>Are you paying in :</h5> <br>
            <a href=""><button type="button" class="btn btn-warning">DOLLARS</button></a>
        </div><br>
        <h4>Please Select :</h4><br>
        <h5>Note: prices shown are excluding VAT</h5><br>

        <select name="prix" type="radio" placeholder="Prix">
            <option value="option1" selected>Rate per Delegate = $19000</option>
            <option value="option2">Rate per VIP Delegate = $20000</option>
            <option value="option3">Rate per AAC Member = $15200</option>
        ...
        <input name="telephoneCompagnie" type="number" placeholder="Company telephone number"><br><br>
        <input name="cityCompagnie" type="text" placeholder="City"><br><br>
        <select name="paysCompagnie" type="text" placeholder="Contry">
        ...
        <br>
        <p><input name="enregistrer" type="submit" value="Soummettre"></p>
    </form>
    <?php
    include 'classes/RegisterVip.class.php';
    $registerVip = new RegisterVip;
    if (isset($_POST['enregistrer'])) {
        $registerVip->setPrix($_POST['prix']);
        $registerVip->setMail($_POST['mail']);
        $registerVip->setNomCompagnie($_POST['nomCompagnie']);
        $registerVip->setSiteWebCompagnie($_POST['siteWebCompagnie']);
        $registerVip->setTelephoneCompagnie($_POST['telephoneCompagnie']);
        $registerVip->setCityCompagnie($_POST['cityCompagnie']);
        $registerVip->setPaysCompagnie($_POST['paysCompagnie']);
        $registerVip->setNatureCompagnie($_POST['natureCompagnie']);
        $registerVip->enregistrer($registerVip->getPrix(), $registerVip->getMail(), $registerVip->getNomCompagnie(), $registerVip->getSiteWebCompagnie(), $registerVip->getTelephoneCompagnie(), $registerVip->getCityCompagnie(), $registerVip->getPaysCompagnie(), $registerVip->getNatureCompagnie());
    }
    ?>
</div>
</body>
